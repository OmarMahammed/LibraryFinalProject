        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Book_Photo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Checkouts_Librarians_Librarian_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Penalty_Amount = table.Column<double>(type: "float", nullable: false),
                    TotalDelayDays = table.Column<int>(type: "int", nullable: false),
                    TotalPenaltyAmount = table.Column<float>(type: "real", nullable: false),
                    Is_Paid = table.Column<bool>(type: "bit", nullable: false),
                    Checkouts_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Penalties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Penalties_Checkouts_Checkouts_Id",
                        column: x => x.Checkouts_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Returns_Checkouts_Checkouts_Id",
                        column: x => x.Checkouts_Id,
                        principalTable: "Checkouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_Librarian_Id",
                table: "Checkouts",
                column: "Librarian_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Penalties_Checkouts_Id",
                table: "Penalties",
                column: "Checkouts_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Returns_Checkouts_Id",
                table: "Returns",
                column: "Checkouts_Id");
        }
